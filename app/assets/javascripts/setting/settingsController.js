        ...
        jQuery.ajax({
          ...
          success: function(response){
            ...
            if(response.status == 'ok'){
				$state.go('settings'); //redirect to home
			} 
          }
        })
    };
